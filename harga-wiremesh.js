...
phi()
harga = hbes * berat;
document.getElementById("result").innerHTML = "<span id = 'res'> Berat Wiremesh M" + di + " (per lembar) :  </span>" + berat + "<span id = 'res'> kg <br>HARGA Wire Mesh M" + di + " : Rp "+fR(hbes)+" per kg<br> = Rp </span>"+fR(harga)+"<span id = 'res'> per lembar</span>";
if (se < 1){
